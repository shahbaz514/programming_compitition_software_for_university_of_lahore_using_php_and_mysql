...
<?php
    if (isset($_POST['subQuestion'])) 
    {
      ...
      $sql = mysqli_query($db, "INSERT INTO `anwser`(`question`, `anwser`, `reg`, `lang`, `level`, `submit_time`) VALUES ('".$row['question']."', '$anwser', '".$_SESSION['registration']."', '".$row['language']."', 'level3', NOW())");
      if ($sql) 
      {
